...
<center><h2>客户管理添加</h2><hr /></center>

 
<form action="{{url('/custom/store')}}" method="post" class="form-horizontal" role="form">
	@csrf
 	<div class="form-group">
		<label for="lastname" class="col-sm-2 control-label">客户名称</label>
		<div class="col-sm-10">
			<input type="text" class="form-control" name="cust_name" id="lastname" 
				   placeholder="请输入客户名称">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="sale_name" id="lastname" 
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="cust_phone" id="lastname" 
				   placeholder="请输入客户电话">
 		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="cust_tel" id="lastname" 
				   placeholder="请输入客户手机 ">
 		</div>
	</div>
	<div class="form-group">
